...
<head>
    ...
    <title>Therapist Selection </title>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card therapist-card">
                    ...
                    <img src="../assets/images/che.jpeg" class="card-img-top" alt="Dr. ANEBOM ODETTE, Mental Health Specialist">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card therapist-card">
                    ...
                    <img src="../assets/images/blaise.jpeg" class="card-img-top" alt="Dr. CHENWI BLAISE, Depression & Anxiety Expert">
                    <div class="card-body d-flex flex-column">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card therapist-card">
                    <img src="../assets/images/image.jpeg" class="card-img-top" alt="Dr.CHE LINDA , Trauma & Relationship Counselor">
                    <div class="card-body d-flex flex-column">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="booksession.php" class="btn btn-success">Book Session</a>
                </div>
            </div>
        </div>
    </div>
